...
const ApplicantForm = (role) => {
  ...
  const handleCreditLimitBlur = () => {
    ...
    let currentErrors = { ...errors };
    if (crdLimit > income) {
      currentErrors.creditLimit =
        "Credit limit cannot be larger than annual income";
    } else {
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ display: "flex", gap: "15px" }}>
          ...
          <FormField
            ...
            hint={
              !isUser
                ? "Auto-calculated based on income"
                : "Final approval limit"
            }
          />
        </div>
        <FormField
        ...
        {role.role === ROLES.APPROVER_1 && (
          <FormField
            ...
            id="approver1Comments"
            type="text"
            name="approver1Comments"
            value={formData.approver1Comments}
            onChange={handleChange}
            required
          />
        )}
        ...
        {role.role === ROLES.APPROVER_2 && (
          <>
            ...
            <FormField
              ...
              id="approver2Comments"
              type="text"
              name="approver2Comments"
              value={formData.approver2Comments}
              onChange={handleChange}
              required
            />
          </>
        ...
        {role.role === ROLES.APPROVER_2 && (
          <>
            ...
            <></>
            <button onClick={rejectClick} style={buttonRejectStyle}>
              Reject
            </button>
          </>
        )}
      ...
      {isModalOpenSubmit && (
        <div style={overlayStyle}>
          <div style={modalStyle} role="dialog" aria-modal="true">
            ...
            <button
              ref={closeButtonRef}
              onClick={() => setIsModalOpenSubmit(false)}
            >
              Close
            </button>
          </div>
